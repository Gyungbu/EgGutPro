...
### ex) python eg_gutpro_update_mrs.py "/home/kbkim/EgGutPro/input/GUT_mirror_output_3175.csv"
...
if len(sys.argv) != 2:
    ...
    print("Example: python eg_gutpro_update_mrs.py \"/home/kbkim/EgGutPro/input/GUT_mirror_output_3175.csv\"")
    sys.exit(1)
